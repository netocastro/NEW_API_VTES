...
--
-- Estrutura da tabela `vteslibmeta`
--

DROP TABLE IF EXISTS `vteslibmeta`;

CREATE TABLE `vteslibmeta` (
...
--
-- Extraindo dados da tabela `vteslibmeta`
--

INSERT INTO `vteslibmeta` (`COL 1`, `COL 2`, `COL 3`) VALUES
('Id', 'Name', 'Requirement'),
('100006', 'Abbot', 'sabbat'),
