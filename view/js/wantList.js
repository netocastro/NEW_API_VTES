$(document).ready(function () {
     ...
     * da cripta.
     */
    $("#total-want-crypt").html('');
    if (valorCalculado) {
        $("#total-want-crypt").html(`(${valorCalculado})`);
    }
     ...
     * da livraria.
     */
    $("#total-want-library").html('');
    if (valorCalculado) {
        $("#total-want-library").html(`(${valorCalculado})`);
    }
     ...
     * no banco de dados
     */
    $('#save-want-list').on('click', function (e) {
        e.preventDefault();
        _this = $(this);
        $.ajax({
            url: _this.data('url'),
...
/**
 * OBS:
 * depois colocar pra o usuario salvar varias listas want
 */